...
// we are working with json data so need to handle response either it's error/response
...
func (s *APIServer) handleLogin(w http.ResponseWriter, r *http.Request) error {
	...
	return WriteJSON(w, http.StatusOK, loginRes)
}
...
const JWT_SECRET = "helloQazplm@2023"
